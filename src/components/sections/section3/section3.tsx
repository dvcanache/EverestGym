...
function Section3 () {
  return (
    <div className="items-center flex flex-col border-none w-[90%] lg:w-[85%] h-auto lg:h-[80%] p-[40px] lg:p-[50px] bg-transparent text-white text-[20px] lg:text-[40px] rounded-[25px]">
      ...
      {/* Primera columna */}
      <div className="flex flex-col w-full lg:w-[70%] h-auto lg:pr-[60px] mb-[50px] lg:mb-0">
        ...
        <div>
          <p className="font-oswald font-normal h-auto text-[16px] lg:text-[24px] w-full lg:w-full mt-[10px] text-center">
      ...
      {/* Segunda columna */}
      <div className="overflow-hidden flex flex-row justify-between w-full lg:w-[50%]lg:pr-[50px] mb-[50px] lg:mb-0 h-[1200px]">
        <PricingSlider />
      </div>
