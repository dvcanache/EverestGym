...
const Footer: React.FC = () => {
    return (
        <footer className="w-full h-full text-left font-montserrat flex flex-wrap p-11 pb-11 sm:p-12 lg:p-24 absolute border-t-[13px] border-amarillo bg-transparent text-white">
            <div className="flex flex-wrap w-full justify-between">
                ...
                {/* Logo */}
                <div className="w-0 sm:w-0 lg:w-auto text-left pt-0 border-t-0 pl-0 -ml-4 mb-6 sm:mb-0 lg:mb-0 sm:ml-4">
